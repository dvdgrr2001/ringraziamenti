...
function generateThanks() {
    ...
    console.log("Nome inserito:", firstName); // Debug del valore di Nome
    console.log("Cognome inserito:", lastName); // Debug del valore di Cognome
    ...
    console.log("Classe 'hidden' rimossa"); // Debug della rimozione della classe
}
